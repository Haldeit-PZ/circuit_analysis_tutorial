# File select in Terminal
#import argparse

#def main(input_file_path, data_file, data_location):

 #   with open(input_file_path, 'r') as file:
  #      input_content = file.read()

#if __name__ == "__main__":
 #   input_file_path = input("Please enter the path to the input text file: ") # node file
...
# Input the file directory of your node text file.
input_file_path = os.path.join(script_path, '../pyzero_fitting/PZT.txt')
